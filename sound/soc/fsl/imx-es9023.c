 ...
 * 
 * Basic I2S support for external es9023 DAC, this should work with other DACS.
 *  
...
static int imx_es9023_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_ops imx_es9023_ops = {
	.hw_params = imx_es9023_hw_params,
};

static struct snd_soc_dai_link imx_dai = {
	.name = "imx-es9023",
	.stream_name = "imx-es9023",
	.codec_dai_name = "es9023-hifi",
	.ops = &imx_es9023_ops,
};

static struct snd_soc_card snd_soc_card_imx_3stack = {
	.name = "imx-audio-es9023",
	.dai_link = &imx_dai,
	.num_links = 1,
};

static int imx_es9023_probe(struct platform_device *pdev)
{
...
static int imx_es9023_remove(struct platform_device *pdev)
{
	struct snd_soc_card *card = &snd_soc_card_imx_3stack;
...
static const struct of_device_id imx_es9023_dt_ids[] = {
	{ .compatible = "udoo,imx-audio-es9023", },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, imx_es9023_dt_ids);

static struct platform_driver imx_es9023_driver = {
	.driver = {
		.name = "imx-es9023",
		.owner = THIS_MODULE,
		.pm = &snd_soc_pm_ops,
		.of_match_table = imx_es9023_dt_ids,
	},
	.probe = imx_es9023_probe,
	.remove = imx_es9023_remove,
};

module_platform_driver(imx_es9023_driver);

/* Module information */
MODULE_DESCRIPTION("ALSA SoC i.MX for ES9023");
MODULE_AUTHOR("Jasbir Matharu");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:imx-es9023");
